...
export const metadata: Metadata = {
  // 👉 Your live website address (custom domain — www is the primary on Vercel).
  metadataBase: new URL("https://www.sriumamaheswarayatraniwas.com"),
  title: {
...
const jsonLd = {
  ...
  image: "https://www.sriumamaheswarayatraniwas.com/images/logo.png",
  address: {
    "@type": "PostalAddress",
